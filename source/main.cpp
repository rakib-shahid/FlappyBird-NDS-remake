...
int main()
{
    ...
    while (1)
    {
        ...
        // SPRITES!!!
        // glSprite(0,0,GL_FLIP_NONE,bird_images); <--- bird sprite currently not working
        ...
        */
        ...
        if ((!over) && ((
                            ...
                            //  check if bird is within pipe's xPos
                            && ((bird.xPos + 10 >= pipe1.pipeX) && (bird.xPos <= pipe1.pipeX + 26))) ||
                        (((bird.yPos <= pipe2.pipeY - 25) || (bird.yPos + 10 > (pipe2.pipeY + 25))) && ((bird.xPos + 10 >= pipe2.pipeX) && (bird.xPos <= pipe2.pipeX + 26))) || // same thing for pipe2
                        (
                            ((bird.yPos <= pipe3.pipeY - 25) || (bird.yPos + 10 > (pipe3.pipeY + 25))) && ((bird.xPos + 10 >= pipe3.pipeX) && (bird.xPos <= pipe3.pipeX + 26))) || // same thing for pipe3
                        (
                            ((bird.yPos <= pipe4.pipeY - 25) || (bird.yPos + 10 > (pipe4.pipeY + 25))) && ((bird.xPos + 10 >= pipe4.pipeX) && (bird.xPos <= pipe4.pipeX + 26)))) // same thing for pipe4
